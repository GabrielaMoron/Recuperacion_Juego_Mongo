...
let arrayPalabras =["USENAMEDATABASE", "DBCREATECOLLECTION", "SHOWDBS", "SHOWCOLLECTIONS", "DBNAMECOLLECTIONINSERT", "DBNAMECOLLECTIONFIND", "DBNAMECOLLECTIONFINDONE", "DBNAMECOLLECTIONUPDATE", "DBNAMECOLLECTIONUPDATEMANY", "DBNAMECOLLECTIONDELETEONE", "DBNAMECOLLECTIONDROP", "DBDROPDATABASE"];
...
let ayudas = [
    ...
    "Ver un documento en especifico de los insertados",
    "Actualizar un documento",
    "Actualizar varios documentos",
    "Eliminar un documento",
    "Borrar la coleccion",
    "Borrar la base de datos seleccionada"
]
...
function cargarNuevaPalabra(){
    ...
    if(cantPalabrasJugadas>6){
        ...
        arrayPalabras =["USENAMEDATABASE", "DBCREATECOLLECTION", "SHOWDBS", "SHOWCOLLECTIONS", "DBNAMECOLLECTIONINSERT", "DBNAMECOLLECTIONFIND", "DBNAMECOLLECTIONFINDONE", "DBNAMECOLLECTIONUPDATE", "DBNAMECOLLECTIONUPDATEMANY", "DBNAMECOLLECTIONDELETEONE", "DBNAMECOLLECTIONDROP", "DBDROPDATABASE"];
        ayudas = [
            "Creacion de base de datos",
            "Creacion de una coleccion",
            "Mostrar las bases de datos creadas",
